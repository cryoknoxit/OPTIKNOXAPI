...
namespace OptiKnoxAPI.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public ActionResult<DataTable> ValidateLogin(string username, string password)
        {
        ...
        public ActionResult<DataTable> GetUserDetails(string username)
        {
            Authentication obj = new Authentication();
            obj.UserName = username;
        ...
        public ActionResult<DataTable> CheckUser(string username)
        {
            Authentication obj = new Authentication();
            obj.UserName = username;
        ...
        public ActionResult<DataTable> Generatepassword(string username, string NewPassword)
        {
            Authentication obj = new Authentication();
            obj.UserName = username;
        ...
        public ActionResult<DataTable> GetSubscriptions(string OrgId)
        {
            Authentication obj = new Authentication();
        ...
        [HttpGet]
        [Route("Recent-Logins")]
        public ActionResult<DataTable> GetRecentLogin(string username, string logincount)
        {
            Authentication obj = new Authentication();
            obj.UserName = username;
        ...
        public ActionResult<DataTable> CheckOrganization(string OrganizationName, string ContactName, string ContactNo, string UserName, string Email)
        {
            Authentication obj = new Authentication();
        ...
        public ActionResult<DataTable> OrganizationSignup(Organzation obj)
        {
